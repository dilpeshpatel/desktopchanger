...
class SunEquation:
    ...
    minutes. #TODO: test this theory is actually true.
    """
    ...
    def current_julian_day(self):
        ...
        jdn = self.julian_date(self.date_today.year,self.date_today.month,
                                self.date_today.day)        
        n = jdn - 2451545.0 + 0.0008 
        logging.debug("CUrrent julain day " + str(n))
        return n
    ...
    def julian_date(self, year, month, day):
        ...
        self.jdn = ( (1461*(year+4800+(month-14)/12))/4 
                ...
                + day - 32075 )
        logging.debug("Julian day calculated: " + str(self.jdn))
        return self.jdn
    ...
    def mean_solar_moon(self, n, longitude_west):
        ...
        logging.debug("Mean solar moon: " + str(j_star))
        return j_star
    ...
    def solar_mean_anomaly(self, j_star):
        ...
        logging.debug("Solar mean anaomly: " + str(m))
        return m
    ...
    def equation_of_the_centre(self, m):
        ...
        logging.debug("Equation of the center: " + str(c))
        return c
    ...
    def ecliptic_longitude(self, m, c):
        ...
        logging.debug("Ecliptic longitude: " + str(lam))
        return lam
    ...
    def solar_transit(self, j_star, m, lam):
        ...
        logging.debug("Solar transient: " + str(j_transit))
        return j_transit
